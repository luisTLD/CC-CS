...
import generated.database_pb2 as database__pb2
...
class DatabaseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Replicate = channel.unary_unary(
                '/DatabaseService/Replicate',
                request_serializer=database__pb2.ReplicationRequest.SerializeToString,
                response_deserializer=database__pb2.ReplicationResponse.FromString,
                _registered_method=True)
...
def add_DatabaseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Replicate': grpc.unary_unary_rpc_method_handler(
                    servicer.Replicate,
                    request_deserializer=database__pb2.ReplicationRequest.FromString,
                    response_serializer=database__pb2.ReplicationResponse.SerializeToString,
            ),
    }
...
class DatabaseService(object):
    ...
    def Replicate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/DatabaseService/Replicate',
            database__pb2.ReplicationRequest.SerializeToString,
            database__pb2.ReplicationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
