...
public class Tarefa implements Registro.Registro
{
    ...
    private static int numeroTarefa = 1;

    // Construtor padrão, inicializa com valores padrão
    public Tarefa()
    {
        this(-1, -1, "", LocalDate.now(), LocalDate.now(), "", (byte) 0, new ArrayList<Integer>());
    }

    // Construtor para escrever no arquivo, onde ainda não temos o ID correto
    public Tarefa(int id_c, String n, LocalDate x, LocalDate y, String s, byte p, ArrayList<Integer> rt)
    {
        this(-1, id_c, n, x, y, s, p, rt);
    }

    // Construtor completo para inicialização com todos os campos
    public Tarefa(int i, int ic, String n, LocalDate x, LocalDate y, String s, byte p,ArrayList<Integer> idRotulos)
    {
        ...
        this.idRotulos = idRotulos; // Atrobio o rotulo da tarefa
    }
    ...
    public int getNumeroTarefa() { return this.numeroTarefa; }
    public void setNumeroTarefa(int numeroTarefa) { this.numeroTarefa = numeroTarefa; }
    ...
    public ArrayList<Integer> getIDRotulo() { return this.idRotulos; }
